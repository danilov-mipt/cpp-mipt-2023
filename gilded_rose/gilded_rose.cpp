...
int main() {
  ...
  gr.AddItem("Sulfuras", 50, 99);
  gr.AddItem("Cheese", 3, 20);
  gr.AddItem("Aged Brie", 20, 3);
  gr.AddItem("Backstage Pass", 15, 10);
  gr.AddItem("Conjured Cheese", 3, 20);
  gr.AddItem("Conjured Aged Brie", 3, 20);
  gr.AddItem("Conjured Sulfuras", 3, 20);
  gr.AddItem("Conjured Backstage Pass", 3, 20);
